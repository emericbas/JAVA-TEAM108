...
public class C05_Encapsulatin {
    public static void main(String[] args) {
        /*
        OOP' nin 4 conceptinden biridir
  ...
  Ama gercek hayatta bu ihtiyac vardir
            ...
            Sadece yazma  yetkisi icin setter() methodu
            Sadece okuma  yetkisi icin getter() methodu

            Kodlarimizin daha anlasilir bir sekilde atama ve yazma islemlerini yapmasi  icin de  getter() ve setter () method'lari birlikte kullanilabilir
