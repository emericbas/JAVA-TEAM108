...
public class C02_ArraydenListYapma {
    public static void main(String[] args) {
        ...
        /*
        Verilen bir array'e  liste cevirmek icin 2 yontem vardir
        1- Bir loop ile tum elementleri list'e kopyalamk
        2-asList() kullanmak
        cok tavsiye etmeyiz, cunku 2 buyuk dezavantaji var
