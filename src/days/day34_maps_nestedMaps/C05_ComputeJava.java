package days.day34_maps_nestedMaps;

import java.util.Map;
import java.util.TreeMap;

public class C05_ComputeJava {
    public static void main(String[] args) {
        ...
        harfSayilariMap.computeIfAbsent("T", v -> 3);//absent yoksa denek oldugu icin k yazilmadan v'yi degistiriyoruz
